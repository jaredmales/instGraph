...
enum class putType
{
    light,      ///< an input/output for light
 ...
 */
inline std::string ioDir2String( ioDir type /**< [in] the IOPut type*/ )
{
    if( type == ioDir::input )
        return "input";
    else if( type == ioDir::output )
        return "output";
    else
        return "unknown";
}
 ...
 */
inline char ioDir2Char( ioDir type /**< [in] the IOPut type*/ )
{
    if( type == ioDir::input )
        return 'i';
    else if( type == ioDir::output )
 ...
 */
inline std::string putState2String( putState state /**< [in] the IOPut state*/ )
{
    if( state == putState::off )
        return "off";
    else if( state == putState::waiting )
        return "waiting";
    else if( state == putState::on )
        return "on";
    else
        return "unk";
}
 ...
 */
inline std::string putType2String( putType type /**< [in] the IOPut type*/ )
{
    if( type == putType::light )
        return "light";
    else if( type == putType::data )
        return "data";
    else if( type == putType::power )
        return "power";
    else if( type == putType::mechanical )
        return "mechanical";
    else if( type == putType::fluid )
        return "fluid";
    else
        return "unknown";
}
 ...
 */
inline char putType2Char( putType type /**< [in] the IOPut type*/ )
{
    if( type == putType::light )
        return 'l';
    else if( type == putType::data )
 ...
 */
inline std::string beamState2String( beamState state /**< [in] the beam state*/ )
{
    if( state == beamState::off )
        return "off";
    else if( state == beamState::intermediate )
        return "int";
    else if( state == beamState::on )
        return "on";
    else
        return "unk";
}
